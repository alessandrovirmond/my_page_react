          ...
          <div className="hobbies-container">
              <div className="hobbies-list-wrapper">
                  ...
                  <ul className="hobbies-list">
                      ...
                      <li>⚽ Peladeiro (sagrado aos domingos de manhã)</li>
                      <li>🏋️‍♂️ Em busca do shape na musculação</li>
                      <li>🎮 Fifeiro de plantão (EA FC nas jogatinas com o irmão)</li>
                      <li>🎤 Freestyleiro (arriscando umas rimas de rap)</li>
                      <li>🏖️ Amante de uma boa praia</li>
                      <li>🧠 Apaixonado por aprender (das novas tecnologias ao estudo diário de inglês)</li>
                  </ul>
              </div>
